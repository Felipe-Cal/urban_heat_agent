    ...
    with col2:
        ...
        with tab1:
            ...
            with st.form("login_form"):
                log_email = st.text_input("Email", key="log_email", placeholder="Enter your email address", autocomplete="email")
                log_password = st.text_input("Password", type="password", key="log_password", placeholder="Enter your password", autocomplete="current-password")
        ...
        with tab2:
            ...
            with st.form("signup_form"):
                sign_email = st.text_input("Email", key="sign_email", placeholder="Enter your email address", autocomplete="email")
                sign_password = st.text_input("Password", type="password", key="sign_password", placeholder="Create a password (min 6 characters)", autocomplete="new-password")
                sign_password_confirm = st.text_input("Confirm Password", type="password", key="sign_password_confirm", placeholder="Confirm your password", autocomplete="new-password")
