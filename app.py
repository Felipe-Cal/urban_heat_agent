    ...
    with col2:
        ...
        with tab1:
            ...
            with st.form("login_form"):
                log_email = st.text_input("Email", key="log_email", placeholder="name@example.com", autocomplete="email")
        ...
        with tab2:
            ...
            with st.form("signup_form"):
                sign_email = st.text_input("Email", key="sign_email", placeholder="name@example.com", autocomplete="email")
                sign_password = st.text_input("Password", type="password", key="sign_password", placeholder="••••••••", autocomplete="new-password", help="Must be at least 6 characters long")
                sign_password_confirm = st.text_input("Confirm Password", type="password", key="sign_password_confirm", placeholder="••••••••", autocomplete="new-password")
